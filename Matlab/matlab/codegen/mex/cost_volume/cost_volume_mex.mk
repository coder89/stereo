START_DIR = C:\Users\spas\Desktop\matlab

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2013a
MAKEFILE = cost_volume_mex.mk

include cost_volume_mex.mki
...
MEX_FILE_NAME_WO_EXT = cost_volume_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\cost_volume"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\cost_volume/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\cost_volume/%.cpp
	$(CC) $(CPPFLAGS) "$<"
