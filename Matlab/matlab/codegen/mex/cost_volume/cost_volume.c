...
static emlrtRSInfo emlrtRSI = { 5, "cost_volume",
  "C:/Users/spas/Desktop/matlab/cost_volume.m" };

static emlrtRSInfo b_emlrtRSI = { 11, "cost_volume",
  "C:/Users/spas/Desktop/matlab/cost_volume.m" };

/* Function Definitions */
void cost_volume(cost_volumeStackData *SD, const uint8_T I_left[270000], const
                 uint8_T I_right[270000], const uint8_T G_left[270000], uint8_T
                 G_right[270000], const real_T disparity[2], real_T alpha, const
                 real_T T_c[90000], const real_T T_g[90000], real_T result[90000])
{
  int32_T i0;
  int32_T k;
  uint32_T qY;
  ...
  /*  result */
  for (k = 0; k < 90000; k++) {
    result[k] = alpha * muDoubleScalarMin(T_c[k], SD->f0.aM[k]) + (1.0 - alpha) *
      muDoubleScalarMin(T_g[k], SD->f0.aG[k]);
  }
}
