...
MAKEFILE = imshift_mex.mk

include imshift_mex.mki
...
MEX_FILE_NAME_WO_EXT = imshift_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\imshift"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\imshift/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\imshift/%.cpp
	$(CC) $(CPPFLAGS) "$<"
